...
Prompt injection is NOT an eighth threat — it is a **vector** that activates T1–T7. Same for hallucination and malicious code. The sandbox doesn't care *why* the agent misbehaves. It limits the **blast radius** when it does.
